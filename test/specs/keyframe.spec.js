import Keyframe from 'class/keyframe';


describe( 'Keyframe class', () =>
{
	let keyframe, setKeyframeSpy;

    before( () =>
    {
        setKeyframeSpy = sinon.spy( Keyframe.prototype, 'setKeyframe' );
    } )
    ...
    it( 'should call setKeyframe during instantiation', () =>
    {
        expect( setKeyframeSpy ).to.have.been.calledOnce;
    } );
